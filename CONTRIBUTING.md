# Contributing to modcore Clipboard

Thank you for your interest in contributing to **modcore Clipboard**! Whether you are fixing bugs, adding features, improving documentation, or reporting issues, your help is highly appreciated by the modcore developers.
...
* Clone your forked repository **(do not clone the main repository directly!)**:
    ```sh
    git clone [https://github.com/your-username/modcore-clipboard.git](https://github.com/your-username/modcore-clipboard.git)
    cd modcore-clipboard
    ```
...
* Use **clear and descriptive commit messages**:
    ```sh
    git add .
    git commit -m "Fix: Resolved issue with extension pin system"
    ```
...
* Open a **Pull Request (PR)**:
    * Go to the original repository on GitHub (e.g., `https://github.com/modcoretech/modcore-clipboard`).
...
Thank you for contributing and helping improve **modcore Clipboard**.
